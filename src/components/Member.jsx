          ...
          >
            ...
            {defaultAdmins.includes(member.id) ? (
              ...
              <>
                ...
                {!props.isMember && (
                  <div className=" absolute -right-[5.5rem] pr-4 ">
                    <svg
                      onClick={() => {
                        updateDoc(ref, {
                ...
                {props.isMember ? null : (
                  <div className="absolute  -right-12 pr-4 font-bold">
                    ...
                    <div
                      ...
                      className=" bg-white z-[200] hidden top-0 -right-[8rem] absolute w-32 text-xs  flex flex-col space-y-3 p-4 border shadow-md rounded"
                    >
